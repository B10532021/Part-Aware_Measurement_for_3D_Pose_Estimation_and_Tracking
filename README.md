...
> **Note:** It's a project of [AI^2 Lab](https://github.com/ivclab). The code will be update in [here](https://github.com/ivclab/Part-Aware_Measurement_for_3D_Pose_Estimation_and_Tracking) while there is a new version. Feel free to ask
